...
class TC(nn.Module):
    def __init__(self, device, final_out_channels, timesteps):
        ...
        self.Wk = nn.ModuleList([nn.Linear(final_out_channels, self.num_channels) for i in range(self.timestep)])
        ...
        self.seq_transformer = Seq_Transformer(patch_size=self.num_channels, dim=final_out_channels, depth=4, heads=4, mlp_dim=64)
    ...
    def forward(self, features_aug1, features_aug2):
        ...
        self.timestep = min(self.timestep, int(seq_len/2))
