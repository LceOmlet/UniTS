...
if __name__ == '__main__':
    ...
    if args.eval:
        if task_type == 'classification':
            ...
            out, eval_res = tasks.eval_kmeans(model, train_data, train_labels, test_data, test_labels, 10)
        else:
            assert False
    ...
    with open("result_record_" + args.dataset + ".txt", "a") as result:
        result.write(json.dumps(eval_res) + "\n") 
    print("Finished.")
